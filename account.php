...
<center><p id="hesabim_mail"><?php
    ...
    ?> <b><?php echo $_SESSION['userN']?></b></p>
<p id="hesabim_mail"><?php
    if ($lang == "tr") {
      echo"Bakiye:";
    }
    elseif ($lang == "en") {
...
?> </b></p></center>
<h2 id="hesabim_mail2"><center><?php
    if ($lang == "tr") {
      echo"Hızlı İşlemler";
    }
    elseif ($lang == "en") {
      echo"Quick Transactions";
    }
    ?></center></h2>
<button type="button"data-bs-toggle="modal" data-bs-target="#exampleModal1"  class="menu_islem btn btn-outline-info" style="width: 110px;"><?php
    if ($lang == "tr") {
      echo"Destek";
    }
    elseif ($lang == "en") {
...
<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label"><?php
    if ($lang == "tr") {
      echo"Hızlı İşlemler";
    }
    elseif ($lang == "en") {
  ...
  <option value="2"><?php
    if ($lang == "tr") {
      echo"Hata Bildirimi & Öneri";
    }
    elseif ($lang == "en") {
      echo"Bug report & suggestion";
    }
    ?></option>
  <option value="3"><?php
    if ($lang == "tr") {
      echo"Kötüye Kullanım";
    }
    elseif ($lang == "en") {
      echo"Abuse";
    }
...
<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label"><?php
    ...
    ?></label>
  <textarea placeholder="Max 500 character" name="detaylar" class="form-control" id="exampleFormControlTextarea1" rows="3" maxlength="500"></textarea>
</div>
       
      </div>
      <div class="modal-footer">
        <button type="submit" name="destek" class="btn btn-primary" ><?php
    if ($lang == "tr") {
      echo"Talep Oluştur.";
    }
    elseif ($lang == "en") {
...
<button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal2" class="  menu_islem btn btn-outline-success" style="font-size: 15px;"><?php
    if ($lang == "tr") {
      echo"Şifre Değiştir";
    }
    elseif ($lang == "en") {
...
<div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div id="passwordHelpBlock1" class="form-text" style="color: red;">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" id="gonder" name="sifreyenile"><?php
    if ($lang == "tr") {
...
<a href="login/logout.php"><button type="button"  class="  menu_islem btn btn-outline-danger" style="width: 110px;"><?php
    if ($lang == "tr") {
      echo"Çıkış Yap";
    }
    elseif ($lang == "en") {
...
Kullanıcı Numaranız: <b><?php echo $_SESSION['id']?></b><br>
      ...
      <div class="modal-footer">
        ...
        <form action="islem.php" name="hesapsil" method="post">
        <button type="submit" name="hesapsil" onclick="return window.confirm('Bu işlemin geri dönüşü yok. Onaylıyor musun ?');"  class="btn btn-danger">Hesabımı Askıya Al</button>
        </form>
      </div>
    </div>
  </div>
